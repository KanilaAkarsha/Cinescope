...
function AddMovieForm({ showDialog }) {
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$fb3b17__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createMovie"])(movie);
            if (response?.success) {
                router.refresh();
...
function UpdateMovieForm({ showDialog, movie }) {
    ...
    const handleSubmit = async (event)=>{
        ...
        setIsSubmitting(true);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$39c752__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateMovie"])(movie?.id, movieDoc);
            if (response?.success) {
                router.refresh();
                showDialog(false);
            }
...
function MovieTable({ movies }) {
    ...
    const handleDeleteMovie = async (movieId)=>{
        setIsLoading(true);
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$818abb__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteMovie"])(movieId);
        if (res?.success) {
            setIsLoading(false);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__56574bc3._.js.map