...
function SignupForm() {
    ...
    const validateForm = ({ first_name, last_name, email, password, confirmPassword })=>{
        ...
        if (first_name === "") {
            ...
            return false;
        } else if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EMAIL_REGEX"].test(email)) {
            setError({
                error: true,
    ...
    const handleSubmitForm = async (event)=>{
        ...
        if (validateForm({
            ...
            setIsLoading(true);
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signUp"].email({
                    email,
                    password
                }, {
                    onSuccess: (ctx)=>{
...
function signInWithGoogle() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithPopup"])(auth, provider).then((result)=>{
        const user = result.user;
        console.log("Google user:", user);
    // You can send user info to your backend to create a session
    }).catch((error)=>{
        console.error(error);
    });
}
...
//# sourceMappingURL=_23b42edc._.js.map