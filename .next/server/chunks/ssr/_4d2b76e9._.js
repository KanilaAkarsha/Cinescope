...
"[project]/actions/data:9141e8 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$9141e8__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:9141e8 [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function UsersPage() {
    ...
    const filteredUsers = __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$9141e8__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["users"].filter((user)=>(roleFilter === "all" || user.role === roleFilter) && (user.name.toLowerCase().includes(searchQuery.toLowerCase()) || user.email.toLowerCase().includes(searchQuery.toLowerCase()))).sort((a, b)=>{
...
//# sourceMappingURL=_4d2b76e9._.js.map