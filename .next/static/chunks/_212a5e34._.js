...
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$9141e8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:9141e8 [app-client] (ecmascript) <text/javascript>");
;
...
function UsersPage() {
    ...
    const filteredUsers = __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$9141e8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["users"].filter((user)=>(roleFilter === "all" || user.role === roleFilter) && (user.name.toLowerCase().includes(searchQuery.toLowerCase()) || user.email.toLowerCase().includes(searchQuery.toLowerCase()))).sort((a, b)=>{
...
//# sourceMappingURL=_212a5e34._.js.map