...
function SignupForm() {
    ...
    const validateForm = ({ first_name, last_name, email, password, confirmPassword })=>{
        ...
        if (first_name === "") {
            ...
            return false;
        } else if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EMAIL_REGEX"].test(email)) {
            setError({
                error: true,
    ...
    const handleSubmitForm = async (event)=>{
        ...
        if (validateForm({
            ...
            setIsLoading(true);
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUp"].email({
                    email,
                    password
                }, {
                    onSuccess: (ctx)=>{
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: error.error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "text-red-600 text-xs text-center animate-pulse duration-700",
...
_s(SignupForm, "zWGNcV12zfFVVK4hTF8z7jAPnx0=", false, function() {
    return [
...
//# sourceMappingURL=_686869fb._.js.map