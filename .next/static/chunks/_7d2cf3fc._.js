...
function LoginForm() {
    ...
    const handleGoogleLogin = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signIn"].social({
                provider: "google",
                callbackURL: "/"
            }, {
                onError: (ctx)=>{
...
_s(LoginForm, "PA1sXulWJFG6TSGTy64n9occrFc=", false, function() {
    return [
