 ...
 * @property {Array<{month: string, views: number}>} viewsByMonth
 * @property {Array<{genre: string, count: number}>} genreDistribution
 * @property {Array<{rating: string, count: number}>} ratingDistribution
 * @property {Array<{title: string, views: number}>} topMovies
 */
